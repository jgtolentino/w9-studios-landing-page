...
[hidden]:where(:not([hidden="until-found"])) {
  ...
  :root {
    --studio-black: 26, 26, 26;
    --studio-blue: 0, 102, 255;
    --studio-red: 232, 65, 65;
    --studio-white: 245, 245, 245;
  }
...
.button-primary:hover {
  ...
  --tw-shadow-color: rgb(0 102 255 / 0.2);
...
.border-studio-red {
  --tw-border-opacity: 1;
  border-color: rgb(232 65 65 / var(--tw-border-opacity, 1));
}
...
.bg-studio-red {
  --tw-bg-opacity: 1;
  background-color: rgb(232 65 65 / var(--tw-bg-opacity, 1));
}
.bg-transparent {
...
.from-studio-blue\/30 {
  --tw-gradient-from: rgb(0 102 255 / 0.3) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(0 102 255 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-studio-gold\/20 {
...
.from-studio-gold\/30 {
  --tw-gradient-from: rgb(212 175 55 / 0.3) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(212 175 55 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-studio-red\/20 {
  --tw-gradient-from: rgb(232 65 65 / 0.2) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(232 65 65 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-studio-red\/30 {
  --tw-gradient-from: rgb(232 65 65 / 0.3) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(232 65 65 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.to-studio-red\/20 {
  --tw-gradient-to: rgb(232 65 65 / 0.2) var(--tw-gradient-to-position);
}
.to-transparent {
...
.text-studio-red {
  --tw-text-opacity: 1;
  color: rgb(232 65 65 / var(--tw-text-opacity, 1));
}
.text-studio-white {
  --tw-text-opacity: 1;
  color: rgb(245 245 245 / var(--tw-text-opacity, 1));
}
.text-studio-white\/50 {
...
.hover\:border-studio-blue:hover {
  --tw-border-opacity: 1;
  border-color: rgb(0 102 255 / var(--tw-border-opacity, 1));
}
...
.hover\:text-studio-black:hover {
  --tw-text-opacity: 1;
  color: rgb(26 26 26 / var(--tw-text-opacity, 1));
}
.hover\:text-studio-blue:hover {
  --tw-text-opacity: 1;
  color: rgb(0 102 255 / var(--tw-text-opacity, 1));
}
.hover\:text-studio-white:hover {
  --tw-text-opacity: 1;
  color: rgb(245 245 245 / var(--tw-text-opacity, 1));
}
...
.focus\:border-studio-blue:focus {
  --tw-border-opacity: 1;
  border-color: rgb(0 102 255 / var(--tw-border-opacity, 1));
}
...
.group:hover .group-hover\:text-studio-blue {
  --tw-text-opacity: 1;
  color: rgb(0 102 255 / var(--tw-text-opacity, 1));
}
@media (min-width: 640px) {
